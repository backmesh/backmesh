...
describe('Stripe Integration CRUD Operations with Firebase', () => {
	...
	it('fails to create webhook with no token', async () => {
		response = await SELF.fetch(`${baseUrl}/crud/stripe/backmeshUid`, {
			method: 'POST',
			headers: {
	...
	it('fails to create webhook with invalid uid', async () => {
		response = await SELF.fetch(`${baseUrl}/crud/stripe/invalid_uid`, {
			method: 'POST',
			headers: {
				Authorization: testUserJwt,
			},
	...
	it('fails to update webhook with invalid id', async () => {
		response = await SELF.fetch(`${baseUrl}/crud/stripe/${testUserId}/invalid_id`, {
			method: 'PUT',
			headers: {
				Authorization: testUserJwt,
			},
...
describe('Stripe Admin/Self Subscription Tests', () => {
	...
	it('successfully create subscription in backmesh itself', async () => {
		...
		response = await SELF.fetch(`${baseUrl}/stripe`, {
			method: 'POST',
			headers: {
...
describe('Webhook Endpoint Tests', () => {
	...
	it('fails webhook call with invalid webhook ID', async () => {
		response = await SELF.fetch(`${baseUrl}/stripe/${testUserId}/invalid_webhook_id`, {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
				'Stripe-Signature': 'invalid_signature',
